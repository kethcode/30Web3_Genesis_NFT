...
contract Renderer {
    ...
    function _render() public pure returns (string memory) {
        string memory gradientStart = "#4229BA";
        string memory gradientEnd = "#FF00FF";
